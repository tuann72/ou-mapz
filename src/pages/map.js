...
//   console.log("TITLE: " + events[i].getTitle() + "\nAddress: " + events[i].getAddress() + "\n DESCRIPT: " + events[i].getDescription() + "\n START DATE: " + events[i].getStartDate() + "\n END DATE " + events[i].getEndDate() + "\n LOCATION:  " + events[i].getLocation());
//   console.log("\n\n\n NEW EVENT: \n");
// }
